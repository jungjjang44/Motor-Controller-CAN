...
{
  new (message_memory) custom_msgs::msg::CameraInfo(_init);
}

void CameraInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::CameraInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraInfo_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::CameraInfo, avg_distance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::CameraInfo, image_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CameraInfo_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs::msg::CameraInfo),
...
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::CameraInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, CameraInfo)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::CameraInfo_message_type_support_handle;
}
